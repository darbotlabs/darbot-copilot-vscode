...
export const HAS_IGNORED_FILES_MESSAGE = l10n.t('\n\n**Note:** Some files were excluded from the context due to content exclusion rules. Click [here](https://docs.github.com/en/copilot/managing-darbot-copilot-in-your-organization/configuring-content-exclusions-for-darbot-copilot) to learn more.');
